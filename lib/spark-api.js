...
var SparkApi = function(args) {
  this.request = require('./request-fetch-adapter');
 ...
 */
SparkApi.prototype.listDevices = function (params) {
  return this.request({
 ...
 * @endpoint GET /v1/devices
 */
SparkApi.prototype.getDevice = function (params) {
  this.request({
 ...
 */
SparkApi.prototype.createUser = function (username, password) {
  this.request({
 ...
 * @endpoint PUT /v1/devices/<core_id>
*/
SparkApi.prototype.changeProduct = function (coreId, product_id, should_update, accessToken) {
  this.request({
    uri: this.baseUrl + '/v1/devices/' + coreId,
    method: 'PUT',
    form: {
 ...
 */
SparkApi.prototype.getAttributes = function (coreId, accessToken) {
  this.request({
 ...
 */
SparkApi.prototype.getVariable = function (coreId, name, accessToken) {
  this.request({
 ...
 * @endpoint PUT /v1/devices/<core_id>
 */
SparkApi.prototype.signalCore = function (coreId, signal, accessToken) {
  this.request({
    uri: this.baseUrl + '/v1/devices/' + coreId,
    method: 'PUT',
    form: {
 ...
 * @endpoint PUT /v1/devices/<core_id>
 */
SparkApi.prototype.flashTinker = function (coreId, accessToken) {
  this.request({
    uri: this.baseUrl + '/v1/devices/' + coreId,
    method: 'PUT',
    form: {
...
// * @endpoint PUT /v1/devices/<core_id>
// */
//SparkApi.prototype.flashCore = function (coreId, files, accessToken) {
 ...
 * @endpoint GET /<url>
 */
SparkApi.prototype.downloadBinary = function (url, filename, accessToken) {
 ...
 */
SparkApi.prototype.sendPublicKey = function (coreId, buffer, accessToken) {
  this.request({
 ...
 */
SparkApi.prototype.callFunction = function (coreId, functionName, funcParam, accessToken) {
  return this.request({
 ...
 * @returns {Promise}
 */
SparkApi.prototype.publishEvent = function (eventName, data, accessToken) {
  return this.request({
 ...
 * @returns {Promise}
 */
SparkApi.prototype.createWebhook = function (eventName, url, coreId, accessToken) {
  var body = {
    event: eventName,
    url: url,
    access_token: accessToken
 ...
 * @returns {Promise}
 */
SparkApi.prototype.deleteWebhook = function (hookId, accessToken) {
  return this.request({
 ...
 * @returns {Promise}
 */
SparkApi.prototype.listWebhooks = function (accessToken) {
  return this.request({
